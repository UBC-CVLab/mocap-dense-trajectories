% This function is a demo that generates trajectories. It is an
% improvement on speed wrt the previous version.
% 
% --
% Julieta
...
%% First load the data and create metadata.
...
%% Convert back to physical trajectories and visualize.
tic;
for i=1:numel(all_traj),
